// 1. 强制刷新缓存，确保每一次在 GitHub 的修改都即时全网同步
...
export default function Home() {
  return (
    <div style={{
      ...
      {/* 2. 顶部高级通栏：还原绿色森林自然风格背景，更换新公司名，字体高清奢华 */}
      <div style={{
        width: '100%',
      ...
      {/* 3. 中部核心区：彻底解决第三张图加载失败问题！全部换上顶级纯净护肤配图，锁死横向三栏 */}
      <main style={{
        maxWidth: '1200px',
        width: '100%',
        margin: '0 auto',
        ...
        <div style={{
          ...
          {/* 🌟 产品 3: Whitening lotion（终极修复：使用稳健链接的高清化妆品配图，呼应原本高级感） */}
          <div style={{ backgroundColor: '#ffffff', borderRadius: '20px', padding: '24px', boxShadow: '0 10px 25px -5px rgba(0,0,0,0.05)', display: 'flex', flexDirection: 'column', alignItems: 'center', textAlign: 'center', transition: 'all 0.3s ease' }}>
            <div style={{ width: '100%', height: '300px', overflow: 'hidden', borderRadius: '14px', backgroundColor: '#f3f4f6' }}>
              <img 
        ...
        <div style={{ maxWidth: '1200px', margin: '0 auto', display: 'flex', flexWrap: 'wrap', justifyContent: 'space-between', alignItems: 'center', gap: '20px' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: '12px' }}>
            ...
            <div style={{ display: 'flex', gap: '15px' }}>
              <a href="#" style={{ width: '42px', height: '42px', borderRadius: '50%', backgroundColor: '#1e293b', color: '#ffffff', display: 'flex', textDecoration: 'none', fontSize: '0.85rem', fontWeight: 'bold', display: 'flex', justifyContent: 'center', alignItems: 'center', transition: 'all 0.3s' }} title="Instagram">IG</a>
              <a href="#" style={{ width: '42px', height: '42px', borderRadius: '50%', backgroundColor: '#1e293b', color: '#ffffff', display: 'flex', textDecoration: 'none', fontSize: '0.85rem', fontWeight: 'bold', display: 'flex', justifyContent: 'center', alignItems: 'center', transition: 'all 0.3s' }} title="TikTok">TK</a>
              <a href="#" style={{ width: '42px', height: '42px', borderRadius: '50%', backgroundColor: '#1e293b', color: '#ffffff', display: 'flex', textDecoration: 'none', fontSize: '0.85rem', fontWeight: 'bold', display: 'flex', justifyContent: 'center', alignItems: 'center', transition: 'all 0.3s' }} title="WhatsApp">WA</a>
              <a href="mailto:info@linximian.com" style={{ width: '42px', height: '42px', borderRadius: '50%', backgroundColor: '#1e293b', color: '#ffffff', display: 'flex', textDecoration: 'none', fontSize: '1rem', display: 'flex', justifyContent: 'center', alignItems: 'center', transition: 'all 0.3s' }} title="Email">✉</a>
            </div>
          </div>
